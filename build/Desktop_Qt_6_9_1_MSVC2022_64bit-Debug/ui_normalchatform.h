/********************************************************************************
** Form generated from reading UI file 'normalchatform.ui'
**
...
#ifndef UI_NORMALCHATFORM_H
#define UI_NORMALCHATFORM_H
...
public:
    ...
    void setupUi(QWidget *NormalChatForm)
    {
        if (NormalChatForm->objectName().isEmpty())
            NormalChatForm->setObjectName("NormalChatForm");
        NormalChatForm->resize(800, 550);
        toolBox = new QToolBox(NormalChatForm);
        ...
        sendButton = new QPushButton(NormalChatForm);
        sendButton->setObjectName("sendButton");
        sendButton->setGeometry(QRect(715, 480, 80, 60));
        stackedWidget = new QStackedWidget(NormalChatForm);
        ...
        retranslateUi(NormalChatForm);

        toolBox->setCurrentIndex(1);


        QMetaObject::connectSlotsByName(NormalChatForm);
    } // setupUi

    void retranslateUi(QWidget *NormalChatForm)
    {
...
namespace Ui {
    class NormalChatForm: public Ui_NormalChatForm {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_NORMALCHATFORM_H
